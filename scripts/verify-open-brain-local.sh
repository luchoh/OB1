...
CALLER_LLM_BASE_URL_SET="${LLM_BASE_URL+x}"
CALLER_LLM_HEALTH_URL="${LLM_HEALTH_URL-}"
CALLER_LLM_HEALTH_URL_SET="${LLM_HEALTH_URL+x}"
CALLER_LLM_MODEL="${LLM_MODEL-}"
CALLER_LLM_MODEL_SET="${LLM_MODEL+x}"
CALLER_EMBEDDING_BASE_URL="${EMBEDDING_BASE_URL-}"
CALLER_EMBEDDING_BASE_URL_SET="${EMBEDDING_BASE_URL+x}"
CALLER_EMBEDDING_HEALTH_URL="${EMBEDDING_HEALTH_URL-}"
CALLER_EMBEDDING_HEALTH_URL_SET="${EMBEDDING_HEALTH_URL+x}"
CALLER_EMBEDDING_MODEL="${EMBEDDING_MODEL-}"
CALLER_EMBEDDING_MODEL_SET="${EMBEDDING_MODEL+x}"
CALLER_DOCLING_BASE_URL="${DOCLING_BASE_URL-}"
CALLER_DOCLING_BASE_URL_SET="${DOCLING_BASE_URL+x}"
CALLER_DOCLING_HEALTH_URL="${DOCLING_HEALTH_URL-}"
CALLER_DOCLING_HEALTH_URL_SET="${DOCLING_HEALTH_URL+x}"
CALLER_CONSUL_HTTP_ADDR="${CONSUL_HTTP_ADDR-}"
CALLER_CONSUL_HTTP_ADDR_SET="${CONSUL_HTTP_ADDR+x}"
CALLER_CONSUL_HTTP_TOKEN="${CONSUL_HTTP_TOKEN-}"
CALLER_CONSUL_HTTP_TOKEN_SET="${CONSUL_HTTP_TOKEN+x}"
CALLER_CONSUL_SKIP_TLS_VERIFY="${CONSUL_SKIP_TLS_VERIFY-}"
CALLER_CONSUL_SKIP_TLS_VERIFY_SET="${CONSUL_SKIP_TLS_VERIFY+x}"
...
[[ -n "$CALLER_LLM_BASE_URL_SET" ]] && export LLM_BASE_URL="$CALLER_LLM_BASE_URL"
[[ -n "$CALLER_LLM_HEALTH_URL_SET" ]] && export LLM_HEALTH_URL="$CALLER_LLM_HEALTH_URL"
[[ -n "$CALLER_LLM_MODEL_SET" ]] && export LLM_MODEL="$CALLER_LLM_MODEL"
[[ -n "$CALLER_EMBEDDING_BASE_URL_SET" ]] && export EMBEDDING_BASE_URL="$CALLER_EMBEDDING_BASE_URL"
[[ -n "$CALLER_EMBEDDING_HEALTH_URL_SET" ]] && export EMBEDDING_HEALTH_URL="$CALLER_EMBEDDING_HEALTH_URL"
[[ -n "$CALLER_EMBEDDING_MODEL_SET" ]] && export EMBEDDING_MODEL="$CALLER_EMBEDDING_MODEL"
[[ -n "$CALLER_DOCLING_BASE_URL_SET" ]] && export DOCLING_BASE_URL="$CALLER_DOCLING_BASE_URL"
[[ -n "$CALLER_DOCLING_HEALTH_URL_SET" ]] && export DOCLING_HEALTH_URL="$CALLER_DOCLING_HEALTH_URL"
[[ -n "$CALLER_CONSUL_HTTP_ADDR_SET" ]] && export CONSUL_HTTP_ADDR="$CALLER_CONSUL_HTTP_ADDR"
[[ -n "$CALLER_CONSUL_HTTP_TOKEN_SET" ]] && export CONSUL_HTTP_TOKEN="$CALLER_CONSUL_HTTP_TOKEN"
[[ -n "$CALLER_CONSUL_SKIP_TLS_VERIFY_SET" ]] && export CONSUL_SKIP_TLS_VERIFY="$CALLER_CONSUL_SKIP_TLS_VERIFY"
...
LLM_MODEL="${LLM_MODEL:-DeepSeek-V4-Flash-nvfp4}"
