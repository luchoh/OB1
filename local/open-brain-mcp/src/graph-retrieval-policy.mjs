...
const defaultPolicy = Object.freeze({
  ...
  ranking: {
    ...
    bundleCountBonus: 40,
    bundleGraphSupportBonus: 45,
    bundleSeedGraphBridgeBonus: 60,
    primaryBundleRowBonus: 120,
    primaryBundleMinItems: 2,
    sameTitleBonus: 30,
    sameSourceBonus: 10,
    sameTypeBonus: 8,
...
function normalizePolicy(raw) {
  ...
  return {
    ...
    ranking: {
      ...
      bundleCountBonus: Number(ranking.bundle_count_bonus) || defaultPolicy.ranking.bundleCountBonus,
      bundleGraphSupportBonus: Number(ranking.bundle_graph_support_bonus) || defaultPolicy.ranking.bundleGraphSupportBonus,
      bundleSeedGraphBridgeBonus: Number(ranking.bundle_seed_graph_bridge_bonus) || defaultPolicy.ranking.bundleSeedGraphBridgeBonus,
      primaryBundleRowBonus: Number(ranking.primary_bundle_row_bonus) || defaultPolicy.ranking.primaryBundleRowBonus,
      primaryBundleMinItems: Number(ranking.primary_bundle_min_items) || defaultPolicy.ranking.primaryBundleMinItems,
